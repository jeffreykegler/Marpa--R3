...
sub intset_id {
    ...
    my $intset_by_key = $asf->[Marpa::R3::Internal_ASF2::INTSET_BY_KEY];
    my $intset_id     = $intset_by_key->{$key};
    return $intset_id if defined $intset_id;
    $intset_id = $asf->[Marpa::R3::Internal_ASF2::NEXT_INTSET_ID]++;
...
sub Marpa::R3::Nidset::obtain {
    ...
    my $nidset_by_id = $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID];
...
sub Marpa::R3::Powerset::obtain {
    ...
    my $powerset_by_id = $asf->[Marpa::R3::Internal_ASF2::POWERSET_BY_ID];
...
sub set_last_choice {
    my ( $asf, $nook ) = @_;
    my $or_nodes   = $asf->[Marpa::R3::Internal_ASF2::OR_NODES];
    ...
    if ( nook_has_semantic_cause( $asf, $nook ) ) {
        my $slr       = $asf->[Marpa::R3::Internal_ASF2::SLR];
...
END_OF_LUA
    ...
    $asf->[Marpa::R3::Internal_ASF2::GLADES]->[$glade_id]
        ->[Marpa::R3::Internal::Glade::REGISTERED] = 1;
    glade_obtain( $asf, $glade_id );
    return $glade_id;
} ## end sub Marpa::R3::ASF2::peak
...
sub asf_common_set {
    ...
    if ( my $value = $flat_args->{'trace_file_handle'} ) {
        $asf->[Marpa::R3::Internal_ASF2::TRACE_FILE_HANDLE] = $value;
    }
    my $trace_file_handle =
      $asf->[Marpa::R3::Internal_ASF2::TRACE_FILE_HANDLE];
    delete $flat_args->{'trace_file_handle'};
    return $flat_args;
}

# Returns undef if no parse
sub Marpa::R3::ASF2::new {
    my ( $class, @args ) = @_;
    my $asf = bless [], $class;
    ...
    Marpa::R3::exception(
        qq{Marpa::R3::ASF2::new() called without a "recognizer" argument} )
      if not defined $slr;
    $asf->[Marpa::R3::Internal_ASF2::SLR] = $slr;
    ...
    $asf->[Marpa::R3::Internal_ASF2::L] = $lua;

        ARG: for my $arg ( keys %{$flat_args} ) {
            if ( $arg eq 'factoring_max' ) {
                $asf->[Marpa::R3::Internal_ASF2::FACTORING_MAX] =
                    $flat_args->{$arg};
...
END_OF_LUA
    ...
    return if $regix < 0;
    $asf->[Marpa::R3::Internal_ASF2::REGIX]  = $regix;

    $asf->[Marpa::R3::Internal_ASF2::FACTORING_MAX] //= 42;
    $asf->[Marpa::R3::Internal_ASF2::NEXT_INTSET_ID] = 0;
    $asf->[Marpa::R3::Internal_ASF2::INTSET_BY_KEY]  = {};
    $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID]   = [];
    $asf->[Marpa::R3::Internal_ASF2::POWERSET_BY_ID] = [];
    $asf->[Marpa::R3::Internal_ASF2::GLADES] = [];
...
} ## end sub Marpa::R3::ASF2::new

sub Marpa::R3::ASF2::DESTROY {
    # say STDERR "In Marpa::R3::ASF2::DESTROY before test";
    my $asf = shift;
    my $lua = $asf->[Marpa::R3::Internal_ASF2::L];
    ...
    return if not $lua;
    # say STDERR "In Marpa::R3::ASF2::DESTROY after test";

    my $regix = $asf->[Marpa::R3::Internal_ASF2::REGIX];
    $asf->call_by_tag(
        ('@' . __FILE__ . ':' . __LINE__),
        <<'END_OF_LUA', '');
    local asf = ...
...
sub Marpa::R3::ASF2::glade_is_visited {
    my ( $asf, $glade_id ) = @_;
    my $glade = $asf->[Marpa::R3::Internal_ASF2::GLADES]->[$glade_id];
    return if not $glade;
    return $glade->[Marpa::R3::Internal::Glade::VISITED];
} ## end sub Marpa::R3::ASF2::glade_is_visited

sub Marpa::R3::ASF2::glade_visited_clear {
    my ( $asf, $glade_id ) = @_;
    my $glade_list =
        defined $glade_id
        ? [ $asf->[Marpa::R3::Internal_ASF2::GLADES]->[$glade_id] ]
    ...
    return;
} ## end sub Marpa::R3::ASF2::glade_visited_clear
...
sub Marpa::R3::ASF2::grammar {
    my ($asf)   = @_;
    my $slr     = $asf->[Marpa::R3::Internal_ASF2::SLR];
    my $slg = $slr->[Marpa::R3::Internal_R::SLG];
    return $slg;
} ## end sub Marpa::R3::ASF2::grammar

# TODO -- Document this method
sub Marpa::R3::ASF2::recognizer {
    my ($asf)   = @_;
    my $slr     = $asf->[Marpa::R3::Internal_ASF2::SLR];
    return $slr;
}
...
sub glade_obtain {
    ...
    my $factoring_max = $asf->[Marpa::R3::Internal_ASF2::FACTORING_MAX];

    my $glades = $asf->[Marpa::R3::Internal_ASF2::GLADES];
    ...
    my $base_nidset =
        $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID]->[$glade_id];
    my $choicepoint;
    ...
    $asf->[Marpa::R3::Internal_ASF2::GLADES]->[$glade_id] = $glade;
    return $glade;
} ## end sub glade_obtain

sub Marpa::R3::ASF2::glade_symch_count {
    my ( $asf, $glade_id ) = @_;
...
sub Marpa::R3::ASF2::glade_literal {
    my ( $asf, $glade_id ) = @_;
    my $nidset_by_id = $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID];
...
} ## end sub Marpa::R3::ASF2::glade_literal

sub Marpa::R3::ASF2::glade_g1_span {
    my ( $asf, $glade_id ) = @_;
    my $nidset_by_id = $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID];
    my $nidset       = $nidset_by_id->[$glade_id];
    Marpa::R3::exception("No glade found for glade ID $glade_id)") if not defined $nidset;
...
sub Marpa::R3::ASF2::glade_L0_length {
    my ( $asf, $glade_id ) = @_;
...
sub Marpa::R3::ASF2::g1_glade_symbol_id {
    my ( $asf, $glade_id ) = @_;
    my $nidset_by_id = $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID];
    my $nidset       = $nidset_by_id->[$glade_id];
    Marpa::R3::exception("No glade found for glade ID $glade_id)") if not defined $nidset;
...
sub Marpa::R3::ASF2::g1_symch_rule_id {
...
sub Marpa::R3::ASF2::symch_factoring_count {
    my ( $asf, $glade_id, $symch_ix ) = @_;
    my $glade = glade_obtain( $asf, $glade_id );
    Marpa::R3::exception("No glade found for glade ID $glade_id)") if not defined $glade;
    my $symches = $glade->[Marpa::R3::Internal::Glade::SYMCHES];
...
} ## end sub Marpa::R3::ASF2::symch_factoring_count

sub Marpa::R3::ASF2::factoring_downglades {
...
sub Marpa::R3::ASF2::factoring_symbol_count {
    my ( $asf, $glade_id, $symch_ix, $factoring_ix ) = @_;
...
} ## end sub Marpa::R3::ASF2::factoring_symbol_count

sub Marpa::R3::ASF2::factor_downglade {
    my ( $asf, $glade_id, $symch_ix, $factoring_ix, $symbol_ix ) = @_;
    my $factoring = $asf->factoring_downglades($glade_id, $symch_ix, $factoring_ix);
    return if not defined $factoring;
    return $factoring->[$symbol_ix];
} ## end sub Marpa::R3::ASF2::factor_downglade

sub Marpa::R3::Internal_ASF2::ambiguities {
    my ($asf) = @_;
    my $peak = $asf->peak();
    return Marpa::R3::Internal_ASF2::glade_ambiguities( $asf, $peak, [] );
}

sub Marpa::R3::Internal_ASF2::glade_ambiguities {
    my ( $asf, $glade, $seen ) = @_;
...
END_OF_LUA
    ...
    return $result;
} ## end sub Marpa::R3::Internal_ASF2::ambiguities_show

# The higher level calls

sub Marpa::R3::ASF2::traverse {
    ...
    my $traverser  = bless [], "Marpa::R3::Internal_ASF2::Traverse";
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF]      = $asf;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::CODE]     = $method;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::PER_TRAVERSE_OBJECT] = $per_traverse_object;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::VALUES]   = [];
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE]    = $peak_glade;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::SYMCH_IX] = 0;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::FACTORING_IX] = 0;
    return $method->( $traverser, $per_traverse_object );
} ## end sub Marpa::R3::ASF2::traverse

sub Marpa::R3::Internal_ASF2::Traverse::all_choices {
    my ( $traverser ) = @_;

    my @values = Marpa::R3::Internal_ASF2::Traverse::rh_values( $traverser );
    my @results = ( [] );
...
# TODO -- Document this method
sub Marpa::R3::Internal_ASF2::Traverse::asf {
    my ( $traverser ) = @_;
    return $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF];
}

sub Marpa::R3::Internal_ASF2::Traverse::literal {
    my ( $traverser ) = @_;
    my $asf = $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF];
    my $glade = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $glade_id = $glade->[Marpa::R3::Internal::Glade::ID];
    return $asf->glade_literal($glade_id);
}

# TODO document span() -> g1_span()
sub Marpa::R3::Internal_ASF2::Traverse::g1_span {
    my ( $traverser ) = @_;
    my $asf = $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF];
    my $glade = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $glade_id = $glade->[Marpa::R3::Internal::Glade::ID];
...
sub Marpa::R3::Internal_ASF2::Traverse::symbol_id {
    my ( $traverser ) = @_;
    my $asf = $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF];
    my $glade = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $glade_id = $glade->[Marpa::R3::Internal::Glade::ID];
...
sub Marpa::R3::Internal_ASF2::Traverse::rule_id {
    my ( $traverser ) = @_;
    my $glade = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $symch_ix =
        $traverser->[Marpa::R3::Internal_ASF2::Traverse::SYMCH_IX];
    my $symch = $glade->[Marpa::R3::Internal::Glade::SYMCHES]->[$symch_ix];
    my ( $rule_id ) = @{$symch};
    return if $rule_id < 0;
    return $rule_id;
} ## end sub Marpa::R3::Internal_ASF2::Traverse::rule_id

sub Marpa::R3::Internal_ASF2::Traverse::rh_length {
    my ( $traverser ) = @_;
    my $glade = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $symch_ix =
        $traverser->[Marpa::R3::Internal_ASF2::Traverse::SYMCH_IX];
    ...
    Marpa::R3::exception(
        ...
        if $rule_id < 0;
    my $factoring_ix =
        $traverser->[Marpa::R3::Internal_ASF2::Traverse::FACTORING_IX];
    my $factoring = $factorings[$factoring_ix];
    return scalar @{$factoring};
} ## end sub Marpa::R3::Internal_ASF2::Traverse::rh_length

sub Marpa::R3::Internal_ASF2::Traverse::rh_value {
    ...
    my $memoized_value = $traverser->[Marpa::R3::Internal_ASF2::Traverse::VALUES]->[$downglade_id];
    ...
    $child_traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE] =
        $downglade;
    $child_traverser->[Marpa::R3::Internal_ASF2::Traverse::SYMCH_IX]     = 0;
    $child_traverser->[Marpa::R3::Internal_ASF2::Traverse::FACTORING_IX] = 0;
    my $code  = $traverser->[Marpa::R3::Internal_ASF2::Traverse::CODE];
    my $value = $code->(
        $child_traverser,
        $traverser->[Marpa::R3::Internal_ASF2::Traverse::PER_TRAVERSE_OBJECT]
    );
    Marpa::R3::exception(
        'The ASF traversing method returned undef -- that is not allowed')
        if not defined $value;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::VALUES]->[$downglade_id]
        = $value;
    return $value;
} ## end sub Marpa::R3::Internal_ASF2::Traverse::rh_value

sub Marpa::R3::Internal_ASF2::Traverse::rh_values {
    my ( $traverser ) = @_;
    return map { Marpa::R3::Internal_ASF2::Traverse::rh_value( $traverser, $_ ) }
        0 .. Marpa::R3::Internal_ASF2::Traverse::rh_length( $traverser ) - 1;
}

sub Marpa::R3::Internal_ASF2::Traverse::next_factoring {
    my ($traverser) = @_;
    my $glade       = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $glade_id = $glade->[Marpa::R3::Internal::Glade::ID];
    my $asf         = $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF];
    my $symch_ix = $traverser->[Marpa::R3::Internal_ASF2::Traverse::SYMCH_IX];
    my $last_factoring =
    ...
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::FACTORING_IX] =
        $factoring_ix;
    return $factoring_ix;
} ## end sub Marpa::R3::Internal_ASF2::Traverse::next_factoring

sub Marpa::R3::Internal_ASF2::Traverse::next_symch {
    my ($traverser) = @_;
    my $glade       = $traverser->[Marpa::R3::Internal_ASF2::Traverse::GLADE];
    my $glade_id = $glade->[Marpa::R3::Internal::Glade::ID];
    my $asf         = $traverser->[Marpa::R3::Internal_ASF2::Traverse::ASF];
    ...
    $symch_ix++;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::SYMCH_IX] = $symch_ix;
    $traverser->[Marpa::R3::Internal_ASF2::Traverse::FACTORING_IX] = 0;
    return $symch_ix;
} ## end sub Marpa::R3::Internal_ASF2::Traverse::next_symch

sub Marpa::R3::Internal_ASF2::Traverse::next {
    my ($traverser) = @_;
...
sub Marpa::R3::ASF2::show_nidsets {
    my ($asf)   = @_;
    my $text    = q{};
    my $nidsets = $asf->[Marpa::R3::Internal_ASF2::NIDSET_BY_ID];
    for my $nidset ( grep {defined} @{$nidsets} ) {
        $text .= $nidset->show() . "\n";
    }
    return $text;
} ## end sub Marpa::R3::ASF2::show_nidsets

sub Marpa::R3::ASF2::show_powersets {
    my ($asf)     = @_;
    my $text      = q{};
    my $powersets = $asf->[Marpa::R3::Internal_ASF2::POWERSET_BY_ID];
    for my $powerset ( grep {defined} @{$powersets} ) {
        $text .= $powerset->show() . "\n";
    }
    return $text;
} ## end sub Marpa::R3::ASF2::show_powersets
...
# not to be documented
sub Marpa::R3::ASF2::and_node_tag {
    my ( $asf, $and_node_id ) = @_;
...
# not to be documented
sub Marpa::R3::ASF2::verbose_or_node {
    my ( $asf, $or_node_id ) = @_;
    my $slr = $asf->[Marpa::R3::Internal_ASF2::SLR];
    my $slg = $slr->[Marpa::R3::Internal_R::SLG];
...
# not to be documented
sub Marpa::R3::ASF2::or_nodes_show {
    my ( $asf ) = @_;
...
# not to be documented
sub Marpa::R3::ASF2::and_nodes_show {
    my ( $asf ) = @_;
    my ($result) = $asf->call_by_tag(
    ('@' . __FILE__ . ':' . __LINE__),
    <<'END_OF_LUA', '');
...
sub Marpa::R3::ASF2::ambiguity_level {
    my ($asf) = @_;
