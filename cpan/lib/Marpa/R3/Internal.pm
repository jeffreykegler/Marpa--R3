...
use constant BLESSING_BY_IRLID => 6;
use constant BLESSING_BY_ISYID => 7;
use constant SEMANTICS_PACKAGE => 8;
use constant TRACE_ACTIONS => 9;
use constant NULL_VALUES => 10;
use constant CLOSURE_BY_SYMBOL_ID => 11;
use constant CLOSURE_BY_RULE_ID => 12;
use constant IF_INACCESSIBLE => 13;
