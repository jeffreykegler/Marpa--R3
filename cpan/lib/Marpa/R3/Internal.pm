...
use constant LEXEME_EVENT_BY_ID => 6;
use constant SYMBOL_IDS_BY_EVENT_NAME_AND_TYPE => 7;
use constant BLESS_PACKAGE => 8;
use constant IF_INACCESSIBLE => 9;
use constant WARNINGS => 10;
use constant CHARACTER_CLASSES => 11;
use constant SEMANTICS_PACKAGE => 12;
use constant TRACE_ACTIONS => 13;
use constant NULL_VALUES => 14;
use constant CLOSURE_BY_SYMBOL_ID => 15;
use constant CLOSURE_BY_RULE_ID => 16;
