...
use constant SLR => 0;
use constant SLV => 1;
use constant LEXEME_RESOLUTIONS => 2;
use constant RULE_RESOLUTIONS => 3;
use constant FACTORING_MAX => 4;
use constant RULE_BLESSINGS => 5;
use constant SYMBOL_BLESSINGS => 6;
use constant SYMCH_BLESSING_PACKAGE => 7;
use constant FACTORING_BLESSING_PACKAGE => 8;
use constant PROBLEM_BLESSING_PACKAGE => 9;
use constant DEFAULT_RULE_BLESSING_PACKAGE => 10;
use constant DEFAULT_TOKEN_BLESSING_PACKAGE => 11;
use constant OR_NODES => 12;
use constant GLADES => 13;
use constant INTSET_BY_KEY => 14;
use constant NEXT_INTSET_ID => 15;
use constant NIDSET_BY_ID => 16;
use constant POWERSET_BY_ID => 17;
