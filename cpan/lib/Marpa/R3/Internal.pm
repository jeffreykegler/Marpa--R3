...
use constant NULLED_EVENT_BY_ID => 6;
use constant PREDICTION_EVENT_BY_ID => 7;
use constant LEXEME_EVENT_BY_ID => 8;
use constant SYMBOL_IDS_BY_EVENT_NAME_AND_TYPE => 9;
use constant BLESS_PACKAGE => 10;
use constant IF_INACCESSIBLE => 11;
use constant WARNINGS => 12;
use constant CHARACTER_CLASSES => 13;
use constant SEMANTICS_PACKAGE => 14;
