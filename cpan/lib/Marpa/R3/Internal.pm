...
use constant R_C => 2;
use constant THICK_G1_RECCE => 3;
use constant P_INPUT_STRING => 4;
use constant EXHAUSTION_ACTION => 5;
use constant REJECTION_ACTION => 6;
use constant TRACE_FILE_HANDLE => 7;
use constant TRACE_LEXERS => 8;
use constant TRACE_TERMINALS => 9;
use constant TRACE_VALUES => 10;
use constant TRACE_ACTIONS => 11;
use constant READ_STRING_ERROR => 12;
use constant EVENTS => 13;
use constant ERROR_MESSAGE => 14;
use constant MAX_PARSES => 15;
use constant RANKING_METHOD => 16;
use constant NO_PARSE => 17;
use constant NULL_VALUES => 18;
use constant PER_PARSE_CONSTRUCTOR => 19;
use constant RESOLVE_PACKAGE => 20;
use constant RESOLVE_PACKAGE_SOURCE => 21;
use constant REGISTRATIONS => 22;
