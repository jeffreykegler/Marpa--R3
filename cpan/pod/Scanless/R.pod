...
If the
L<pause span|Marpa::R3::Event/"Pause span and pause lexeme">
is defined,
...
event|Marpa::R3::Event/"Types of parse event">.
...
L<pause lexeme|Marpa::R3::Event/"Pause span and pause lexeme">.
...
The "pause span" is
described in detail
L<in another document|Marpa::R3::Event/"Pause span and pause lexeme">.
