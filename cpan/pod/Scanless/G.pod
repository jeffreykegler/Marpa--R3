...
recognizer|Marpa::R3::Scanless::R/"semantics_package">.
...
L<C<action> adverb|Marpa::R3::Scanless::DSL/"action">
in a
...
For details, see L<Marpa::R3::NAIF::Grammar/"default_action">.
...
combination with
the SLIF's
of L<the progress method|Marpa::R3::Scanless::R/progress()>,
