...
For example, SLIF authors sometimes write
...
and 
entirely up to the SLIF author.
The SLIF allows any event to have any legal
event name.
...
the SLIF grammar's C<ranking_method> named argument
