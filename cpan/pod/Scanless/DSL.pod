...
and
L<discard pseudo-rules|/"Discard pseudo-rule">.
The C<eager> adverb may be specified
as a default.
...
In most of this documentation set, it is assumed
that "greedy" matching is in effect
...
Several tokens may match, and they may be all greedy,
