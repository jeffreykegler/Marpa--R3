...
the order in which
the L<SLIF recognizer's C<value()> method|Marpa::R3::Scanless::R/"value()">
evaluates the parse
...
By calling
the recognizer's
L<C<value()>|Marpa::R3::Scanless::R/"value()">
method
repeatedly,
...
L<the recognizer's C<ranking_method>|Marpa::R3::Scanless::R/"ranking_method">
named argument.
...
argument|Marpa::R3::Scanless::R/"ranking_method">,
...
for example, a
L<prioritized rule|Marpa::R3::Scanless::DSL/"Prioritized rule">.
...
for RHS alternatives|Marpa::R3::Scanless::DSL/"null-ranking">
