...
But earlemes do behave like locations should --
They are monotonic, each Earley set has a unique earleme location,
and higher numbered Earley sets are guaranteed to have higher numbered
locations.
(Earlemes are desribed more formally in
