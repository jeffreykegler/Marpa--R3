...
Marpa::R3::External::Models - Other input models
...
As an alternative is using the C<earleme()> method,
an application
may want to implement an Earley set to earleme mapping
at the application level.
This allows the application taking advantage of what
