...
=head1 The low level scanning mutators

This document describes the behavior of Marpa::R3's
L<low level external scanning
methods|Marpa::R3::External::Basic/"Low-level mutators">:
That is, the
L<C<lexeme_completion()>|Marpa::R2::External::Basic/"lexeme_completion()">,
L<C<lexeme_alternative()>|Marpa::R2::External::Basic/"lexeme_alternative()">,
and
L<C<lexeme_alternative_literal()>|Marpa::R2::External::Basic/"lexeme_alternative_literal()">
methods.
The
L<lexeme_alternative()|Marpa::R2::External::Basic/"lexeme_alternative()">
and
L<C<lexeme_alternative_literal()>|Marpa::R2::External::Basic/"lexeme_alternative_literal()">
has the same effect in terms of Earley set and earleme location.
Unless explicitly stated otherwise,
Whenever a statement this document refers to
the "C<lexeme_alternative()>" method,
that statement also applies
to the "C<lexeme_alternative_literal()>" method.
