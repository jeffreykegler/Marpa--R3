...
A value, which may be undefined.
Together,
...
all of them must have the same literal equivalent.
...
will want to use the top-level methods.
...
Use of the low-level methods allows, among other things,
