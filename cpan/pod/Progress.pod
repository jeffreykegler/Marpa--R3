...
Here are the progress reports for B1L1c17.
Earley set 5,
from our example.
...
Prefixed to the dotted rule are two or three fields
of location information.
In the example just above they are "C<F1 B1L1c1>".
The "C<F1>" says that this is a completed or B<final> rule,
