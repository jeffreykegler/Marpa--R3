...
use the
The L<C<event_is_active>|/"event_is_active"> recognizer setting
...
It is a fatal error if C<offset_arg> cannot
...
It is a fatal error if C<$length_arg> cannot
