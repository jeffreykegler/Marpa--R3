...
where C<$block_id_arg> is undefined or a block ID,
...
It is a fatal error if C<block_id> is undefined
...
It is a fatal error is C<offset_arg> cannot
...
It is a fatal error is C<$length_arg> cannot
