...
is addressed in L<Marpa::R3::Scanless::R/"Literals and G1 spans">.
...
The L<$slr-E<gt>is_ambiguous() method|Marpa::R3::Scanless::R/"is_ambiguous()">
tests an already-existing boolean and is therefore extremely fast.
If you are simply testing for ambiguity,
use the C<is_ambiguous()> method instead.
If you can save time when you know that a parse is unambiguous,
you may want to test for ambiguity with the C<is_ambiguous()> method
