...
in the development of Marpa::R3.
In previous versions of Marpa::R3,
...
directly|Marpa::R3::Scanless::R/"pause_lexeme()">
is discouraged,
...
L<C<:lexeme> pseudo-rules|Marpa::R3::Scanless::DSL/"Lexeme pseudo-rule">,
when
L<the C<pause> adverb|Marpa::R3::Scanless::DSL/"pause"> 
is used without
L<the C<event> adverb|Marpa::R3::Scanless::DSL/"event">.
Since the
L<the C<pause> adverb|Marpa::R3::Scanless::DSL/"pause">
...
method|Marpa::R3::Scanless::R/"pause_lexeme()">
