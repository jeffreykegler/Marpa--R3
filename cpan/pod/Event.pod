...
a C<'pause'> return value overrides
...
In common with most other event types,
prediction events will trigger at their event location.
Pre-lexeme events will not trigger
at the event location --
they will trigger later in the parse.
