...
They are created
with the
L<Marpa::R3::Scanless:G::new|Marpa::R3::Scanless::G/"Constructor">
constructor.
The arguments to
L<Marpa::R3::Scanless::G::new|Marpa::R3::Scanless::G/"Constructor">
are references to
...
explicitly|Marpa::R3::Scanless::DSL/"Start rule">.)
...
=head2 Marpa::R3::Scanless::G::parse
...
To parse a string,
we use
the C<Marpa::R3::Scanless::G::parse()> method.
C<Marpa::R3::Scanless::G::parse()> requires a reference
...
and Marpa::R3 does not support them.
