...
=head2 The Thin interface (THIF) is being removed.

The THIF is being removed.
This is being done piecemeal for the convenience
of the Marpa::R3 developers.
Nobody outside the Marpa::R3 development team
should attempt to use the THIF.
