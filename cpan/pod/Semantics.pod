...
L<the grammar|Marpa::R3::Scanless::G> being parsed.

=item * C<$Marpa::R3::Context::recognizer> is set to
L<the recognizer|Marpa::R3::Scanless::R> that did this parse.

=item * C<$Marpa::R3::Context::valuer> is set to
L<the valuer|Marpa::R3::Scanless::V> that is doing
this evaluation.
...
L<the grammar's C<production_expand()> method|Marpa::R3::Scanless::G/"production_expand()">.
