...
argument|Marpa::R3::Scanless::R/"semantics_package">,
...
the
L<C<series_restart()> method|Marpa::R3::Scanless::R/"series_restart()">.)
...
Note that these are
L<G1 locations|Marpa::R3::Scanless::R/"G1 locations">,
...
in the
L<Parse Tree Setup Subphase|Marpa::R3::Semantics::Phases/"Parse Tree Setup Subphase">.
The Parse Tree Setup Subphase occurs during
the first call to a recognizer's L<C<value()>|Marpa::R3::Scanless::R/"value()">
...
semantics|Marpa::R3::Semantics::Phases>.
