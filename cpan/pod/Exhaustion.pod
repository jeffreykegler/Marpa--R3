...
and the
L<C<lexeme_complete()>|Marpa::R3::Scanless::R/"lexeme_complete()"> method.
...
setting|Marpa::R3::Scanless::G/"exhaustion">.
...
can set the
L<SLIF's C<exhaustion> grammar setting|Marpa::R3::Scanless::G/"exhaustion">
